...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($edad)) { array_push($errors, "Edad requerida"); }
  if (empty($genero)) { array_push($errors, "Genero requerido"); }
  ...
  if (count($errors) == 0) {
    //encryptar la contraseña
  	...
  	$query = "INSERT INTO users (username, email, password , edad, genero) 
  			  VALUES('$username', '$email', '$password', '$edad', '$genero')";
